...
// Register Custom Post Type
function new_testimonial_post_type() {

	$labels = array(
		'name'                  => 'Testimonials',
		'singular_name'         => 'Testimonial',
		'menu_name'             => 'All Testimonials',
		'name_admin_bar'        => 'Add Testimonial',
	...
	$args = array(
		'label'                 => 'Testimonial',
		'description'           => 'Testimonials for the site',
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor', 'author', 'thumbnail', 'revisions', ),
		'hierarchical'          => false,
		'public'                => true,
...
add_action( 'init', 'new_testimonial_post_type', 0 );
